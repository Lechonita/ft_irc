...
# define ERR_ERRONEUSNICKNAME	"\033[0;33m432 <arg> :Erroneus nickname\033[0m"
# define ERR_NICKNAMEINUSE		":<servername> 433 * <oldnickname> :Nickname is already in use."
...
# define ERR_BADCHANNELKEY		":<servername> 475 <client> <channelName> :Cannot join channel (+k)"
